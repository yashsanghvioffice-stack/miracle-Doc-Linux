...
MSG_INVALID_EMAIL                   = "email must be one or more valid email addresses, comma-separated"
MSG_TOO_MANY_PARTNER_EMAILS         = "partner email accepts at most 20 addresses"
